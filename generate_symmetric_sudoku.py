...
def generate_rotational_symmetric_sudoku(grid_size):
    ...
    num_clues = grid_size * 3  # Adjust the number of clues as needed
...
def save_puzzles_to_file(puzzles, file_path):
    with open(file_path, "w") as file:
        for puzzle in puzzles:
            ...
            file.write("\n")  # Separate puzzles with a blank line
...
# Usage
grid_size = 9  # Change to 4, 9, or 16 depending on the Sudoku type
count = 50
